...
import tickMarkk from "./GlobalImages/checkMark.png";
...
import { CheckTwoTone, Clear, Visibility, VisibilityOff } from "@mui/icons-material";
...
const MultiStepForm = () => {
  ...
  const customColors = ['#1a2c57', '#32773e', '#623277', '#342839', '#dc3545', '#00b6ff'];
  ...
  const shouldDisableButtonsFirst = () => {
    return allFilesSelected();
  };

  const shouldDisableButtonsAdditionalFirst = () => {
    return allFilesSelectedAdditional();
  };
  ...
  const submitApplicationForOldUsers = async () => {
    const token = localStorage.getItem("token");
    ...
    setTaxYears((prevTaxYears) =>
      prevTaxYears.map((taxYear) => {
        if (taxYear.year === year) {
          return {
            ...taxYear,
            eFiled: option === "eFiled",
            mailed: option === "mailed",
          };
        } else {
          return taxYear;
        }
  ...
  const formDataUpdateStepSixAndOne = async (step) => {
    const formattedStartDate = personal_startdate2020
      ? personal_startdate2020.toLocaleDateString()
      : "";
    const formattedEndDate = personal_enddate2020
  ...
  const handleNext = async () => {
    ...
    if (token) {
      if (activeStep === 0) {
        formDataUpdateStepSixAndOne(activeStep);
      }
    } else {
      if (activeStep === 0) {
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      ...
      setCurrentColorIndex((prevIndex) => (prevIndex + 1) % customColors.length);
    }, 1000); // Change color every 2 seconds

    return () => clearInterval(intervalId); // Cleanup on component unmount
  }, []); // Empty dependency array to run the effect once on mount

  const currentColor = customColors[currentColorIndex];
        ...
        try {
          ...
          if (response.ok) {
            ...
            setFormData((prevData) => ({
              ...
              setc_program2021:
                userData?.have_you_filed_already_for_setc_2021 || "",
              covid_related_issues2021:
                userData?.did_you_miss_SEWDTC_2021 || "",
 ...
 ${errors.zipCode ? "border-danger" : ""}`}
                        ...
                        <>
                          <div id="additional">
                            <label
                              ...
                              className="form-label requiredField"
                            >
                              Would you be interested in learning about our
                              referral program?
                            </label>
                            <div className="optio mb-2">
                    ...
                    <div className="d-flex justify-content-end">
                      <button
                        ...
                        // disabled={loading}
                      >
                        {loading ? <CircularProgress size={22} /> : "Let's Get Started!"}
                      </button>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="start-application">
                    <div className="row roww">
                      <div className="col-lg-12 col-md-12 col-sm-12">
                        <div
                          class="img-applic-content border-0 pb-0"
                          style={{
                            height: "100vh",
                            display: "flex",
                          ...
                          <div style={{ marginTop: 40 }}>
                            ...
                            >
                              ...
                              <span
                                ...
                                onClick={() => window.open(Pdf2019, "_blank")}
                              >
                                1040 Schedule SE
                              </span>{" "}
                      ...
                      <div className="col-lg-8 col-md-8 col-sm-12">
                        <div className="img-applic-content">
                          ...
                          <div style={{ marginTop: 40 }}>
                            ...
                            >
                              Did you receive any unemployment income during
                              April 1st, 2020 - December 31st, 2020?
                            </h1>
                      ...
                      <div className="col-lg-8 col-md-8 col-sm-12">
                        <div className="img-applic-content">
                          ...
                          <label
                            ...
                            style={{ fontWeight: "600" }}
                          >
                            Did you miss work because you were personally sick
                            with Covid, experienced Covid like symptoms, needed
                            to quarantine, or underwent testing from April 1st,
                            2020 - December 31st, 2020?{" "}
                            <span
                              style={{
                                color: "red",
                                cursor: "pointer",
                          ...
                          <div>
                            ...
                            {formData.personallySick2020 === "Yes" && (
                              ...
                              >
                                ...
                                >
                                  Click to add individual dates below
                                </Typography>
                      ...
                      <div className="col-lg-8 col-md-8 col-sm-12">
                        <div className="img-applic-content">
                          ...
                          >
                            Did you miss work because you were personally sick
                            with Covid, experienced Covid like symptoms, needed
                            to quarantine, or underwent testing from January 1st
                            - September 30th 2021?{" "}
                            <span
                              style={{
                                color: "red",
                      ...
                      <div className="col-lg-8 col-md-8 col-sm-12">
                        <div className="img-applic-content">
                          ...
                          <label
                            ...
                            style={{ fontWeight: "600" }}
                          >
                            Did you miss work because you cared for someone else
                            who was affected by Covid, experienced Covid like
                            symptoms, needed to quarantine or underwent testing
                            from April 1st - December 31st, 2020?{" "}
                            <span
                              style={{
                                color: "red",
                                cursor: "pointer",
                      ...
                      <div className="col-lg-8 col-md-8 col-sm-12">
                        <div className="img-applic-content">
                          ...
                          >
                            ...
                            child who was affected by covid during April 1st,
                            2020 - March 31st, 2021 ?{" "}
                            <span
                              style={{
                                color: "red",
                                cursor: "pointer",
                          ...
                          <div>
                            ...
                            {formData.closure2020 === "Yes" && (
                              ...
                              >
                                ...
                                >
                                  Select date range and press Add Dates button
                                </Typography>
                                ...
                                >
                                  ...
                                  <div className="">
                                    <button
                                      ...
                                      type="button"
                                      className="px-3 py-2 next-step"
                                      style={{backgroundColor: 'orangered', border: '1px solid orangered'}}
                                    >
                                ...
                                >
                                  ...
                                  <div className="">
                                    <button
                                      ...
                                      //   document.querySelector('.next-step').style.color = 'white';
                                      // }}
                                      // onMouseOut={() => {
                        ...
                        <div className="img-applic-content">
                          ...
                          <div style={{ marginTop: 40 }}>
                            <label
                              ...
                              style={{ fontWeight: "600" }}
                            >
                              Were you also employed as a W2 from April 1st,
                              2020-September 30th, 2021?
                            </label>
                              ...
                              <>
                                <div id="additional">
                                  <label
                                    ...
                                    className="form-label bg-light py-3 px-1 fs-5"
                                  >
                                    Did your employer pay Family Sick Leave
                              ...
                              <div style={{ textAlign: "center" }}>
                                <div className="modal-body d-flex justify-content-center flex-column align-items-center pt-0">
                                  ...
                                  <h5 className="text-center pb-4">
                                    ...
                                    <br />
                                    <div class="mt-3" style={{fontSize: 18}} > 
                                      {userData?.verified_first && (
                                        <>
                                     Your legal name is{" "}
    <span className="capitalizee">
      {userData?.verified_first || ""} {userData?.verified_middleName || ""} {userData?.verified_last || ""}
    </span>
                            ...
                            <div
                              class="title d-flex align-items-center justify-content-center mb-4 w-100 text-center"
                            ...
                            <div className="d-flex justify-content-center mt-3">
                              ...
                              <button
                                ...
                                type="button"
                                style={{
                                  fontSize: userData?.approval_status
                                    ? "20px"
                                    : "",
                                }}
                                // className="px-3 py-2 next-step"
       ...
       ${errors.zipCode ? "border-danger" : ""}`}
                    ...
                    <div className="data-p py-2 mb-2">
                      <p>
                        ...
                        />
                        By checking this box you attest that the answers and
                        information provided are true and accurate to the best
                        of your knowledge, and understand that once submitted
                        your responses cannot be changed. You agree to our{" "}
                        <a
                          style={{
                            textDecoration: "underline",
                            cursor: "pointer",
        ...
        return (
          ...
          {/* {formData.did_receive_unemployement20 === 'No' && (  */}
                  ...
                  <CheckTwoTone sx={{ fontSize: 35, color: 'green', marginLeft: '30px' }} />
                        ...
                        {userData?.supplemental_attachment_2020 &&
                          userData?.supplemental_attachment_2020.length > 0 &&  userData?.final_review_calculation_amount === null && (
                            <button
                              style={{
                                marginTop: "20px",
                                borderRadius: "6px",
            ...
            {/* {formData.did_receive_unemployement21 === 'No' && (  */}
                  ...
                  <CheckTwoTone sx={{ fontSize: 35, color: 'green', marginLeft: '30px' }} />
                        ...
                        {userData?.supplemental_attachment_2021 &&
                          userData?.supplemental_attachment_2021.length > 0 &&  userData?.final_review_calculation_amount === null && (
                            <button
                              style={{
                                marginTop: "20px",
                                borderRadius: "6px",
       ...
       {/* {formData.did_receive_unemployement20 === 'No' && (  */}
          ...
          {/* {formData.did_receive_unemployement20 === 'No' && ( */}
                  ...
                  <CheckTwoTone sx={{ fontSize: 35, color: 'green', marginLeft: '30px' }} />
                        ...
                        {userData?.ks2020 && userData?.ks2020.length > 0 &&  userData?.final_review_calculation_amount === null && (
                          <button
                            style={{
                              marginTop: "20px",
                              borderRadius: "6px",
         ...
         {/* {formData.did_receive_unemployement21 === 'No' && ( */}
                  ...
                  <CheckTwoTone sx={{ fontSize: 35, color: 'green', marginLeft: '30px' }} />
                        ...
                        {userData?.ks22020 && userData?.ks22020.length > 0 &&  userData?.final_review_calculation_amount === null && (
                          <button
                            style={{
                              marginTop: "20px",
                              borderRadius: "6px",
             ...
             {userData?.final_review_calculation_amount === null ?
                ...
                <>
                  ...
                  <button
                    ...
                    //     : shouldDisableButtonsFirst()
                    // }
                    onClick={submitApplicationForOldUsers}
                  >
                    Proceed to next
                  </button>
                    ) 
      ...
      {userData?.isOldUser ? (
              ...
              <div className="col-md-6 offset-md-3">
                <div className="card">
                  <div className="card-body">
                    <h5 className="card-title">Important Update!</h5>
                    <p className="card-text">
                      We were down for maintenance, updated our system, and will
                      now need you to verify your information. Thank you!
                    </p>
                    <button
        ...
        >
          ...
          {userData?.applicationStatus !== true &&
            userData?.applicationWithDocument !== true && userData?.completed_application !== "true"  && (
              <>{getStepContent()}</>
            )}
            ...
            <>
              <div className="myClas2" style={{ marginBottom: 100 }}>
                <div className="modal-body d-flex justify-content-center flex-column align-items-center pt-0">
                  ...
                  <h5 className="text-center pb-4">
                    <span className="text-success">Great</span>, your
                    application has been submitted. We will send you a personal
                    upload link for your documents.
                  </h5>
            ...
            <>
              <div className="myClas2" style={{ marginBottom: 100 }}>
                <div className="modal-body d-flex justify-content-center flex-column align-items-center pt-0">
                  ...
                  { userData?.completed_application === "true" ?
                  (
                  <h5 className="text-center">
                    {" "}
                    By selecting the option below, you can view the status of your application. Thank you.
                  </h5>
                  ) : 
                  (
                    <h5 className="text-center">
