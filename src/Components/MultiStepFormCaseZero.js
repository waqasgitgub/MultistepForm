...
// const steps = ['Create an ad group', 'Create an ad', 'Step 4', 'Step 5', 'Step 6', 'Step 7', 'Step 8', 'Step 9', 'Step 10', 'Step 11'];
...
//     if (activeStep === 0) {
//       // Navigate to the previous route here
//       // For example:
//       history.push('/application-form/case0');
//     } else {
//       // Your existing logic for decrementing activeStep
//       setActiveStep((prevActiveStep) => prevActiveStep - 1);
//       window.scrollTo(0, 0);
//     }
//   };
    ...
    const fetchUserData = async () => {
      ...
      //  alert(token, 'useeffect tokeeeeeeeeeeeennnnnnnnnnnnnn')
        try {
          ...
          //   // Update the active step with the retrieved step
          // setActiveStep(currentStep || 0);
    ...
    {errors.zipCode}
              ...
              />No
                ...
                checked={formData.isCheckedStepThree}
                  ...
                  />                   evaluate and answer the questions as they
                        ...
                        {formData.selfEmployedFrom === 'No' && activeErrorQualifyOne && (
                         <div>
                          <h4 style={{ color: "#e62e2d" }}>
       Unfortunately, you are not eligible  for this tax created, you must have been self-employed during 2020 and/or 2021.
                            </h4>
      ...
      />  
                              ...
                              <div class="optio mb-2">
                                ...
                                class={` for ${errors.netIncome2019 ? 'border-danger' : ''}`} 
                                name="netIncome2019" 
                                onChange={handleInputChange}
                              ...
                              <div class="optio mb-2">
                                ...
                                value={formData.netIncome2020}
                                 name="netIncome2020" 
                                 class={` for ${errors.netIncome2020 ? 'border-danger' : ''}`} 
                              ...
                              <div class="optio mb-2">
                                <input type="text"
                                  ...
                                  name="netIncome2021"
                                  class={` for ${errors.netIncome2021 ? 'border-danger' : ''}`} 
