  ...
  return (
    <>
      ...
      <div className="container" style={{ marginTop: "120px",marginBottom: "60px"  }}>
        <div
          className="row justify-content-center shadow-lg pb-5"
            ...
            <div className="page">
              <div className="header">
                <div className="container">
                  {/* <!-- <p className="title">Privacy Policy for SETC Zone</p> --> */}
                </div>
              </div>
              <div className="translations-content-container">
                <div className="container">
                  <div
                    ...
                    id="en"
                  >
                    <h1 style={{ marginTop: "12px" }}>Privacy Policy</h1>
                    ...
                    <ul>
                      ...
                      <li>
                        <p>
                          ...
                          CCPA/CPRA, refers to the Company as the legal entity
                          that collects Consumers' personal information and
                          determines the purposes and means of the processing of
                          Consumers' personal information, or on behalf of which
                          such information is collected and that alone, or
                      ...
                      <li>
                        <p>
                          ...
                          <strong>CPRA</strong> refers to the California
                          Consumer Privacy Act (the "CCPA") as amended by the
                      ...
                      <li>
                        <p>
                          ...
                          refers to SETC Zone LLC, 21311 Fitz Lane Magnolia,
                          Texas 77355 USA.
                        </p>
                      </li>
                      <li>
                        <p>
                          <strong>Consumer</strong>, for the purpose of the
                          CCPA/CPRA, means a natural person who is a California
                          resident. A resident, as defined in the law, includes
                          (1) every individual who is in the USA for other than
                          a temporary or transitory purpose, and (2) every
                      ...
                      <li>
                        <p>
                          ...
                          particular the U.S. Federal Trade Commission (FTC),
                          for the Internet industry to develop and implement a
                      ...
                      <li>
                        <p>
                          <strong>Website</strong> refers to SETC Zone,
                          accessible from
                          <a
                            href="https://www.setczone.com"
                            rel="external nofollow noopener"
                            target="_blank"
                          >
                            https://www.setczone.com
                          </a>
                        </p>
                      </li>
                      <li>
                    ...
                    <p>
                      ...
                      third-party vendors use cookies and non-cookie
                      technologies to help Us recognize Your Device and
                      understand how You use our Service so that We can improve
                      our Service to reflect Your interests and serve You
                      advertisements that are likely to be of more interest to
                      You.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      that block cookies. Your browser may not permit You to
                      block such technologies. You can use the following
                      third-party tools to decline the collection and use of
                      information for the purpose of serving You interest-based
                      advertising:
                    </p>
                    <ul>
                      <li>
                    ...
                    <p>
                      ...
                      Limit Ad Tracking (iOS) and Opt Out of Ads Personalization
                      (Android). See Your mobile device Help system for more
                      information.
                    </p>
                    <p>
                    ...
                    <ul>
                      <li>
                        ...
                        <p>
                          ...
                          Advertising and customize the Google Display Network
                      ...
                      <li>
                        ...
                        <p>
                          ...
                          Digital Advertising Alliance. You can also opt-out
                          from Facebook and other participating companies
                    ...
                    <p>
                      ...
                      following is a list of categories of personal information
                      which we may collect or may have been collected from
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <p>
                          ...
                          number, education, employment, employment history,
                      ...
                      <li>
                        <p>
                          <strong>
                            Category C: Protected classNameification
                      ...
                      <li>
                        ...
                        <p>
                          ...
                          biological characteristics, or activity patterns used
                          to extract a template or other identifier or
                      ...
                      <li>
                        ...
                        <p>
                          ...
                          transcripts, className lists, student schedules,
                    ...
                    <ul>
                      <li>
                        <strong>Directly from You</strong>. For example, from
                        the forms You complete on our Service, preferences You
                        express or provide through our Service, or from Your
                      ...
                      <li>
                        ...
                        third-party vendors to provide advertising on our
                        Service, third-party vendors to deliver targeted
                        advertising to You, third-party vendors for payment
                    ...
                    <p>
                      ...
                      under the CCPA/CPRA), which may include the following
                      examples:
                    </p>
                    <ul>
                      <li>
                    ...
                    <p>
                      ...
                      information or use the personal information We collected
                      for materially different, unrelated, or incompatible
                    ...
                    <p>
                      ...
                      party for valuable consideration. This means that We may
                      have received some kind of benefit in return for sharing
                      personal information, but not necessarily a monetary
                      benefit.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      defined in the CCPA/CPRA. This does not mean that all
                      examples of that category of personal information were in
                      fact sold, but reflects our good faith belief to the best
                      of Our knowledge that some of that information from the
                    ...
                    <p>
                      ...
                      representative) may submit a request to Us by contacting
                      Us.
                    </p>
                    <p>
                    ...
                    <ul>
                      <li>
                        ...
                        to be notified which categories of Personal Data are
                      ...
                      <li>
                        <strong>The right to correct Personal Data.</strong> You
                        have the right to correct or rectify any inaccurate
                      ...
                      <li>
                        ...
                        submit, please see the "Limit the Use or Disclosure of
                        My Sensitive Personal Information" section or contact
                        Us.
                      </li>
                      <li>
                        <strong>The right to delete Personal Data.</strong> You
                        have the right to request the deletion of Your Personal
                        Data under certain circumstances, subject to certain
                        exceptions. Once We receive and confirm Your request, We
                        will delete (and direct Our Service Providers to delete)
                        Your personal information from our records, unless an
                    ...
                    <p>
                      ...
                      Personal Information" section for more information on how
                      to opt out and limit the use of sensitive information
                      collected.
                    </p>
                    <p>
                      Additionally, in order to exercise any of Your rights
                      under the CCPA/CPRA, and if You are a California resident,
                      You can contact Us:
                    </p>
                    <ul>
                      <li>
                        <p>
                          By email:
                          <a href="mailto:support@setczone.com">
                    ...
                    <p>
                      ...
                      request. The time period to provide the required
                      information may be extended once by an additional 45 days
                    ...
                    <p>
                      ...
                      provide Your personal information that is readily usable
                    ...
                    <p>
                      ...
                      the CCPA/CPRA law. If you wish to opt out of the use of
                      Your personal information for interest-based advertising
                      purposes and these potential sales as defined under
                      CCPA/CPRA law, you may do so by following the instructions
                      below.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      privacy preferences and opt out of cookies and other
                      technologies that We may use. Please note that You will
                      need to opt out from each browser that You use to access
                      the Service.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      Service. For more information on how We use Your personal
                      information, please see the "Use of Your Personal Data"
                      section or contact us.
                    </p>
                    <h2>
                    ...
                    <p>
                      ...
                      California Shine the Light law, and if You are a
                    ...
                    <ul>
                      <li>
                        <p>By email: support@setczone.com</p>
                      </li>
                      <li>
                        <p>
                          By visiting this page on our website:
