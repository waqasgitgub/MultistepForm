...
const LandingPage = () => {
  ...
  return (
    ...
    <div class="img-applci h-100 ahme" style={{backgroundSize: '100% 100%'}}>
        ...
        <img src={standUp} class="img-fluid" alt="" />
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 ps-0">
                    <div class="img-applic-content align-items-center ahm" style={{border: '2px solid #dff5fc'}}>
                        <h2>Claiming Your Self-Employed Tax Credit (SETC)</h2>
                        ...
                        <div class="d-flex justify-content-center flex-column align-items-center w-100">
                            <div class="btn-apli">
                                ...
                                <a >
                                    <button type="button" class="apli-button-1" onClick={handleClickNewApp}>
                                        Pick up where I left off
                                        <span class="ms-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="16" viewBox="0 0 27 16" fill="none">
                                                <path
                            ...
                            <div class="btn-aplii mb-3">
                                ...
                                <a >
                                    <button type="button" class="apli-buttonn" onClick={handleLogin} >
                            ...
                            <div class="accordion accordion-flush" id="accordionPanelsStayOpenExample">
                                <div class="accordion-item">
                                    <h5 class="accordion-header">
                                        <p class="mb-1 text-start border-bottom-none fw-bold">Help?</p>
                                        ...
                                        <button
                                            ...
                                            style={{borderRadius: "10px", backgroundColor: '#29abe2', color: 'white', fontWeight: '500'}}
                                        >
                                            Get Support
                                    ...
                                    <div id="flush-collapseOne" class="accordion-collapse collapse mt-2" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body" style={{borderRadius: "10px"}}>
                                            ...
                                            <a class="text-white" href="mailto:support@setczone.com"></a>
                                            <p>
                                                <a class="text-white" href="mailto:support@setczone.com">
                                            ...
                                            <a class="text-white" href="https://calendly.com/setc-expert-kayembe/book-an-appointment-with-an-setc-expert-today" target="_blank">
                                                <div class="d-flex">
